...
import com.kanav.newsapp.core.utils.create
...
class NewsSourceServiceTest : BaseServiceTest() {
    ...
    fun getNewsSource() = runBlocking {
        ...
        assertThat(article1.author, `is`("Kanav"))
        assertThat(article1.title, `is`("Oneplus 7t"))
        assertThat(article1.description, `is`("Gift me Apple iphone ;)"))
    }
}